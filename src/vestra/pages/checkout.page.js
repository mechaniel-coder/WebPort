        ...
        <fieldset>
          ...
          <div class="field-row">
            <div class="field">
              ...
              <div class="field__input"><input id="c-first" name="first" required></div>
            </div>
            <div class="field">
              <label for="c-last">Last name</label>
              <div class="field__input"><input id="c-last" name="last" required></div>
            </div>
          </div>
          ...
          <div class="field">
            ...
            <div class="field__input"><input id="c-address" name="address" required></div>
          </div>

          <div class="field-row">
            <div class="field">
              <label for="c-city">City</label>
              <div class="field__input"><input id="c-city" name="city" required></div>
            </div>
            <div class="field">
              <label for="c-postal">Postcode</label>
              <div class="field__input"><input id="c-postal" name="postal" required></div>
            </div>
          </div>
        </fieldset>
